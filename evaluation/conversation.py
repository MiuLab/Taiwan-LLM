...
register_conv_template(
    Conversation(
        name="llama-2-zh-tw",
        system_message="<s>[INST] <<SYS>>\n你是一個有幫助、尊重和誠實的助理。請始終以最有助的方式回答，同時要安全。"
             "你的答案不應包括任何有害、不道德、種族主義、性別歧視、有毒、危險或非法的內容。"
             "請確保你的回應在社交上是無偏見並且積極的。"

             "如果一個問題沒有任何意義，或者事實上並不一致，請解釋為什麼，而不是回答不正確的東西。"
             "如果你不知道問題的答案，請不要分享錯誤的資訊。\n<</SYS>>\n\n",
        roles=("[INST]", "[/INST]"),
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.LLAMA2,
...
if __name__ == "__main__":
    ...
    conv = get_conv_template("llama-2-zh-tw")
